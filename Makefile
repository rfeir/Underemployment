run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|Underemployment\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|Underemployment/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|Underemployment/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|Underemployment/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|Underemployment/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|Underemployment/assets|g' {} \;
